...
STREET_NAME_SET = ("Rankin","Dunkirk","Sandwich","Dunlop","Cavendish","Lavender","Chilly","Snowbert","Rapline","Alshine","AlKareem","Nevestein")
CITY_NAME_SET = ("London","Paris","Toronto","Montreal","Delhi","Ahmedabad","Palitana","Bhuj","Kutch","Nandoorbar","Surrey","Windsor","Kalol")
PROVINCE_SET = ("Ontario","Quebec","Nova Scotia","New Brunswick","Manitoba","British Columbia","Prince Edward Island","Saskatchewan","Alberta","Newfoundland and Labrador")

EMAIL_SET = ("@icloud.com", "@gmail.com", "@yahoo.com", "@protonmail.com", "@live.com")

FIRST_NAME_SET = ("Rajat", "Kamil", "Sarah", "Pritam", "Kajol", "Ramesh", "Kalpit", "Adam", "Lee")
LAST_NAME_SET = ("Patel", "Bhavsar", "Tatum", "Gates", "Bezos", "Sandler", "Panchal", "Modi", "Smith")
...
def random_user_generator():
	...
	phone = reduce(lambda a,b: a+str(b), random.sample(range(0,9), 7), random.choice(PHONE_SERIES))
	telephone = reduce(lambda a,b: a+str(b), random.sample(range(0,9), 6), random.choice(TELE_SERIES))
	address = random_address_generator()
	email = (first_name + "." + last_name + str(random.randint(0,999))).lower() + random.choice(EMAIL_SET)
	user = {
