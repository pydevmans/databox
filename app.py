...
from backend import (
    User, UserProfile, HomePage, UserDatabase, UserDatabases, InteracDatabase,
    SignUp, MembershipFeatures, Login, Logout,  AggregatableTable
    )
...
api.add_resource(InteracDatabase, 
    '/users/<string:username>/databases/<string:database>/<int:pk>')
